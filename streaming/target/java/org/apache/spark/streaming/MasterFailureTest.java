...
public  class MasterFailureTest {
   ...
   * @return (undocumented)
   */
  static private <T extends java.lang.Object> scala.collection.Seq<T> runStreams (org.apache.spark.streaming.StreamingContext _ssc, T lastExpectedOutput, long maxTimeToRun, scala.reflect.ClassTag<T> evidence$3)  { throw new RuntimeException(); }
  /**
