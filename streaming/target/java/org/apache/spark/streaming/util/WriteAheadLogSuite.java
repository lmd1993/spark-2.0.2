...
public  class WriteAheadLogSuite {
  ...
  static public  class BlockingWriteAheadLog extends org.apache.spark.streaming.util.WriteAheadLog {
    ...
    private  boolean isWriteCalled ()  { throw new RuntimeException(); }
    private  boolean blockWrite ()  { throw new RuntimeException(); }
  ...
  static private  org.apache.hadoop.conf.Configuration hadoopConf ()  { throw new RuntimeException(); }
