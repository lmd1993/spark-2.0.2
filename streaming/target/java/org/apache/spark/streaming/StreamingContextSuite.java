...
public  class StreamingContextSuite extends org.apache.spark.SparkFunSuite implements org.scalatest.BeforeAndAfter, org.scalatest.concurrent.Timeouts, org.apache.spark.internal.Logging {
  static private  org.scalatest.PrivateMethodTester.PrivateMethod<scala.collection.mutable.ArrayBuffer<org.apache.spark.metrics.source.Source>> _sources ()  { throw new RuntimeException(); }
  static private  scala.collection.mutable.ArrayBuffer<org.apache.spark.metrics.source.Source> getSources (org.apache.spark.metrics.MetricsSystem metricsSystem)  { throw new RuntimeException(); }
  static private  org.scalatest.PrivateMethodTester.PrivateMethod<org.apache.spark.streaming.StreamingSource> _streamingSource ()  { throw new RuntimeException(); }
  static private  org.apache.spark.streaming.StreamingSource getStreamingSource (org.apache.spark.streaming.StreamingContext streamingContext)  { throw new RuntimeException(); }
