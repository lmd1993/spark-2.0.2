...
public abstract class StreamingQueryListener {
  ...
  static public  class QueryStartedEvent implements org.apache.spark.sql.streaming.StreamingQueryListener.Event {
    public  org.apache.spark.sql.streaming.StreamingQueryStatus queryStatus ()  { throw new RuntimeException(); }
    // not preceding
       QueryStartedEvent (org.apache.spark.sql.streaming.StreamingQueryStatus queryStatus)  { throw new RuntimeException(); }
  }
  /**
   * :: Experimental ::
  ...
  static public  class QueryProgressEvent implements org.apache.spark.sql.streaming.StreamingQueryListener.Event {
    public  org.apache.spark.sql.streaming.StreamingQueryStatus queryStatus ()  { throw new RuntimeException(); }
    // not preceding
       QueryProgressEvent (org.apache.spark.sql.streaming.StreamingQueryStatus queryStatus)  { throw new RuntimeException(); }
  }
  /**
   * :: Experimental ::
   ...
   * param:  exception The exception message of the {@link StreamingQuery} if the query was terminated
  ...
  static public  class QueryTerminatedEvent implements org.apache.spark.sql.streaming.StreamingQueryListener.Event {
    ...
    // not preceding
       QueryTerminatedEvent (org.apache.spark.sql.streaming.StreamingQueryStatus queryStatus, scala.Option<java.lang.String> exception)  { throw new RuntimeException(); }
  }
