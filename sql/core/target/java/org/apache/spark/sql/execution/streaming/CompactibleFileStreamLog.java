 ...
 */
public abstract class CompactibleFileStreamLog<T extends java.lang.Object> extends org.apache.spark.sql.execution.streaming.HDFSMetadataLog<java.lang.Object> {
  ...
  protected abstract  int compactInterval ()  ;
  /**
   * Serialize the data into encoded string.
   * @param t (undocumented)
   * @return (undocumented)
   */
  protected abstract  java.lang.String serializeData (T t)  ;
  /**
   * Deserialize the string into data object.
   * @param encodedString (undocumented)
   * @return (undocumented)
   */
  protected abstract  T deserializeData (java.lang.String encodedString)  ;
  /**
  ...
  public  void serialize (java.lang.Object logData, java.io.OutputStream out)  { throw new RuntimeException(); }
  public  java.lang.Object deserialize (java.io.InputStream in)  { throw new RuntimeException(); }
  public  boolean add (long batchId, java.lang.Object logs)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  private  boolean compact (long batchId, java.lang.Object logs)  { throw new RuntimeException(); }
  /**
   * Returns all files except the deleted ones.
   * @return (undocumented)
   */
  public  java.lang.Object allFiles ()  { throw new RuntimeException(); }
  /**
   * Since all logs before <code>compactionBatchId</code> are compacted and written into the
   * <code>compactionBatchId</code> log file, they can be removed. However, due to the eventual consistency of
   * S3, the compaction file may not be seen by other processes at once. So we only delete files
   * created <code>fileCleanupDelayMs</code> milliseconds ago.
   * @param compactionBatchId (undocumented)
   */
  private  void deleteExpiredLog (long compactionBatchId)  { throw new RuntimeException(); }
}
