 ...
 * </code></pre>
 */
public  class SparkSession implements scala.Serializable, org.apache.spark.internal.Logging {
  /**
   * :: Experimental ::
  ...
  static private  java.lang.String HIVE_SHARED_STATE_CLASS_NAME ()  { throw new RuntimeException(); }
  static private  java.lang.String HIVE_SESSION_STATE_CLASS_NAME ()  { throw new RuntimeException(); }
  static private  java.lang.String sharedStateClassName (org.apache.spark.SparkConf conf)  { throw new RuntimeException(); }
   ...
   * this defaults to the value set in the underlying {@link SparkContext}, if any.
   * <p>
   * @since 2.0.0
   * @return (undocumented)
   */
   ...
   * {@link StreamingQuery StreamingQueries} active on <code>this</code>.
   * <p>
   * @since 2.0.0
   * @return (undocumented)
   */
  ...
  /**
   * :: DeveloperApi ::
   * Creates a {@link DataFrame} from a {@link JavaRDD} containing {@link Row}s using the given schema.
   * It is important to make sure that the structure of every {@link Row} of the provided RDD matches
   * the provided schema. Otherwise, there will be runtime exception.
   * <p>
   * @since 2.0.0
  ...
  /**
   * :: DeveloperApi ::
   * Creates a {@link DataFrame} from a {@link java.util.List} containing {@link Row}s using the given schema.
  ...
  /**
   * :: Experimental ::
   * Creates a {@link Dataset} with a single {@link LongType} column named <code>id</code>, containing elements
  ...
  /**
   * Creates a {@link DataFrame} from an RDD[Row].
  ...
  /**
   * :: Experimental ::
   * Returns a {@link DataStreamReader} that can be used to read streaming data in as a {@link DataFrame}.
   * <pre><code>
