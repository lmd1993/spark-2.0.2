...
public  class TypedColumn<T extends java.lang.Object, U extends java.lang.Object> extends org.apache.spark.sql.Column {
   ...
   * on a decoded object.
   * @param inputDeserializer (undocumented)
   * @param inputAttributes (undocumented)
   * @return (undocumented)
   */
    org.apache.spark.sql.TypedColumn<T, U> withInputType (org.apache.spark.sql.catalyst.expressions.Expression inputDeserializer, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Attribute> inputAttributes)  { throw new RuntimeException(); }
  /**
