...
public  class AggregateProcessor$ {
  ...
  public  org.apache.spark.sql.execution.AggregateProcessor apply (org.apache.spark.sql.catalyst.expressions.Expression[] functions, int ordinal, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Attribute> inputAttributes, scala.Function2<scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Expression>, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Attribute>, org.apache.spark.sql.catalyst.expressions.MutableProjection> newMutableProjection)  { throw new RuntimeException(); }
}
