...
public  class Partition implements scala.Product, scala.Serializable {
  ...
  // not preceding
  public   Partition (org.apache.spark.sql.catalyst.InternalRow values, scala.collection.Seq<org.apache.hadoop.fs.FileStatus> files)  { throw new RuntimeException(); }
}
