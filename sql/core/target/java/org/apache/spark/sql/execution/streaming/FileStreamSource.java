...
public  class FileStreamSource implements org.apache.spark.sql.execution.streaming.Source, org.apache.spark.internal.Logging {
  ...
  private  long maxBatchId ()  { throw new RuntimeException(); }
   ...
   * @return (undocumented)
   */
  private  org.apache.spark.sql.execution.streaming.LongOffset fetchMaxOffset ()  { throw new RuntimeException(); }
  /**
  ...
  public  org.apache.spark.sql.execution.streaming.LongOffset currentOffset ()  { throw new RuntimeException(); }
  /**
