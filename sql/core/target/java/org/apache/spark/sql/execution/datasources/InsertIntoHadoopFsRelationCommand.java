 ...
 * Writing to dynamic partitions is also supported.  Each {@link InsertIntoHadoopFsRelationCommand}
 * issues a single write job, and owns a UUID that identifies this job.  Each concrete
 * implementation of {@link HadoopFsRelation} should use this UUID together with task id to generate
 * unique file path for each task output file.  This UUID is passed to executor side via a
 * property named <code>spark.sql.sources.writeJobUUID</code>.
 * <p>
...
public  class InsertIntoHadoopFsRelationCommand extends org.apache.spark.sql.catalyst.plans.logical.LeafNode implements org.apache.spark.sql.execution.command.RunnableCommand, scala.Product, scala.Serializable {
  ...
  public  scala.Function0<scala.runtime.BoxedUnit> refreshFunction ()  { throw new RuntimeException(); }
  ...
  // not preceding
  public   InsertIntoHadoopFsRelationCommand (org.apache.hadoop.fs.Path outputPath, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Attribute> partitionColumns, scala.Option<org.apache.spark.sql.execution.datasources.BucketSpec> bucketSpec, org.apache.spark.sql.execution.datasources.FileFormat fileFormat, scala.Function0<scala.runtime.BoxedUnit> refreshFunction, scala.collection.immutable.Map<java.lang.String, java.lang.String> options, org.apache.spark.sql.catalyst.plans.logical.LogicalPlan query, org.apache.spark.sql.SaveMode mode)  { throw new RuntimeException(); }
