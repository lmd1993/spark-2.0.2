...
public  class ForeachSinkSuite extends org.apache.spark.sql.QueryTest implements org.apache.spark.sql.streaming.StreamTest, org.apache.spark.sql.test.SharedSQLContext, org.scalatest.BeforeAndAfter {
  static public  class Open implements org.apache.spark.sql.execution.streaming.ForeachSinkSuite.Event, scala.Product, scala.Serializable {
  ...
  static public  class Open$ extends scala.runtime.AbstractFunction2<java.lang.Object, java.lang.Object, org.apache.spark.sql.execution.streaming.ForeachSinkSuite.Open> implements scala.Serializable {
    /**
  ...
  static public  class Process<T extends java.lang.Object> implements org.apache.spark.sql.execution.streaming.ForeachSinkSuite.Event, scala.Product, scala.Serializable {
  ...
  static public  class Close implements org.apache.spark.sql.execution.streaming.ForeachSinkSuite.Event, scala.Product, scala.Serializable {
  ...
  static public  class Close$ extends scala.runtime.AbstractFunction1<scala.Option<java.lang.Throwable>, org.apache.spark.sql.execution.streaming.ForeachSinkSuite.Close> implements scala.Serializable {
    /**
     * Static reference to the singleton instance of this Scala object.
     */
  ...
  static private  java.util.concurrent.ConcurrentLinkedQueue<scala.collection.Seq<org.apache.spark.sql.execution.streaming.ForeachSinkSuite.Event>> _allEvents ()  { throw new RuntimeException(); }
  static public  void addEvents (scala.collection.Seq<org.apache.spark.sql.execution.streaming.ForeachSinkSuite.Event> events)  { throw new RuntimeException(); }
  static public  scala.collection.Seq<scala.collection.Seq<org.apache.spark.sql.execution.streaming.ForeachSinkSuite.Event>> allEvents ()  { throw new RuntimeException(); }
