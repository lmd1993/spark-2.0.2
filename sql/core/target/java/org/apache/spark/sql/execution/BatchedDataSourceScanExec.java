...
public  class BatchedDataSourceScanExec extends org.apache.spark.sql.execution.SparkPlan implements org.apache.spark.sql.execution.DataSourceScanExec, org.apache.spark.sql.execution.CodegenSupport, scala.Product, scala.Serializable {
  ...
  static public  boolean sameResult (org.apache.spark.sql.execution.SparkPlan plan)  { throw new RuntimeException(); }
  ...
  // not preceding
  public   BatchedDataSourceScanExec (scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Attribute> output, org.apache.spark.rdd.RDD<org.apache.spark.sql.catalyst.InternalRow> rdd, org.apache.spark.sql.sources.BaseRelation relation, org.apache.spark.sql.catalyst.plans.physical.Partitioning outputPartitioning, scala.collection.immutable.Map<java.lang.String, java.lang.String> metadata, scala.Option<org.apache.spark.sql.catalyst.TableIdentifier> metastoreTableIdentifier)  { throw new RuntimeException(); }
  ...
  private  org.apache.spark.sql.catalyst.expressions.codegen.ExprCode genCodeColumnVector (org.apache.spark.sql.catalyst.expressions.codegen.CodegenContext ctx, java.lang.String columnVar, java.lang.String ordinal, org.apache.spark.sql.types.DataType dataType, boolean nullable)  { throw new RuntimeException(); }
