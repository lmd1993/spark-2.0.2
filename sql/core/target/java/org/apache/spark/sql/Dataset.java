 ...
 * called a {@link DataFrame}, which is a Dataset of {@link Row}.
 * <p>
...
public  class Dataset<T extends java.lang.Object> implements scala.Serializable {
   ...
   * must be executed as a {@link StreamingQuery} using the <code>start()</code> method in
   * {@link DataStreamWriter}. Methods that return a single answer, e.g. <code>count()</code> or
  ...
  /**
   * :: Experimental ::
   * Joins this Dataset returning a {@link Tuple2} for each pair where <code>condition</code> evaluates to
   * true.
   * <p>
   ...
   * @return (undocumented)
   */
  public <U1 extends java.lang.Object> org.apache.spark.sql.Dataset<U1> select (org.apache.spark.sql.TypedColumn<T, U1> c1, org.apache.spark.sql.Encoder<U1> evidence$3)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public <K extends java.lang.Object> org.apache.spark.sql.KeyValueGroupedDataset<K, T> groupByKey (scala.Function1<T, K> func, org.apache.spark.sql.Encoder<K> evidence$4)  { throw new RuntimeException(); }
  /**
   * :: Experimental ::
   * (Java-specific)
   * Returns a {@link KeyValueGroupedDataset} where the data is grouped by the given key <code>func</code>.
  ...
  */
  public <A extends scala.Product> org.apache.spark.sql.Dataset<org.apache.spark.sql.Row> explode (scala.collection.Seq<org.apache.spark.sql.Column> input, scala.Function1<org.apache.spark.sql.Row, scala.collection.TraversableOnce<A>> f, scala.reflect.api.TypeTags.TypeTag<A> evidence$5)  { throw new RuntimeException(); }
  /**
  ...
  */
   ...
   * @return (undocumented)
   */
  public <U extends java.lang.Object> org.apache.spark.sql.Dataset<U> map (scala.Function1<T, U> func, org.apache.spark.sql.Encoder<U> evidence$7)  { throw new RuntimeException(); }
  /**
   * :: Experimental ::
   * (Java-specific)
   * Returns a new Dataset that contains the result of applying <code>func</code> to each element.
   ...
   * @return (undocumented)
   */
  public <U extends java.lang.Object> org.apache.spark.sql.Dataset<U> mapPartitions (scala.Function1<scala.collection.Iterator<T>, scala.collection.Iterator<U>> func, org.apache.spark.sql.Encoder<U> evidence$8)  { throw new RuntimeException(); }
  /**
   * :: Experimental ::
   * (Java-specific)
  ...
  /**
   * Returns a new {@link DataFrame} that contains the result of applying a serialized R function
   ...
   * @return (undocumented)
   */
  public <U extends java.lang.Object> org.apache.spark.sql.Dataset<U> flatMap (scala.Function1<T, scala.collection.TraversableOnce<U>> func, org.apache.spark.sql.Encoder<U> evidence$9)  { throw new RuntimeException(); }
  /**
   * :: Experimental ::
   * (Java-specific)
   * Returns a new Dataset by first applying a function to all elements of this Dataset,
  ...
  /**
   * Represents the content of the Dataset as an {@link RDD} of {@link T}.
   * <p>
   * @group basic
   * @since 1.6.0
   * @return (undocumented)
  ...
  /**
   * Returns the content of the Dataset as a {@link JavaRDD} of {@link T}s.
   * @group basic
   * @since 1.6.0
   * @return (undocumented)
   */
  ...
  */
  ...
  private <U extends java.lang.Object> org.apache.spark.sql.Dataset<U> withTypedPlan (scala.Function0<org.apache.spark.sql.catalyst.plans.logical.LogicalPlan> logicalPlan, org.apache.spark.sql.Encoder<U> evidence$10)  { throw new RuntimeException(); }
  /** A convenient function to wrap a set based logical plan and produce a Dataset. */
  private <U extends java.lang.Object> org.apache.spark.sql.Dataset<U> withSetOperator (scala.Function0<org.apache.spark.sql.catalyst.plans.logical.LogicalPlan> logicalPlan, org.apache.spark.sql.Encoder<U> evidence$11)  { throw new RuntimeException(); }
}
