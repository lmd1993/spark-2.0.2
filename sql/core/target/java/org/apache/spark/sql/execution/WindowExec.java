...
public  class WindowExec extends org.apache.spark.sql.execution.SparkPlan implements org.apache.spark.sql.execution.UnaryExecNode, scala.Product, scala.Serializable {
   ...
   * @return (undocumented)
   */
  private  scala.collection.Seq<scala.Tuple2<scala.collection.mutable.Buffer<org.apache.spark.sql.catalyst.expressions.Expression>, scala.Function1<org.apache.spark.sql.catalyst.expressions.MutableRow, org.apache.spark.sql.execution.WindowFunctionFrame>>> windowFrameExpressionFactoryPairs ()  { throw new RuntimeException(); }
  /**
