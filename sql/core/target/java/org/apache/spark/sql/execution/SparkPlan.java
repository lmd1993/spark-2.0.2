...
public abstract class SparkPlan extends org.apache.spark.sql.catalyst.plans.QueryPlan<org.apache.spark.sql.execution.SparkPlan> implements org.apache.spark.internal.Logging, scala.Serializable {
   ...
   * @return (undocumented)
   */
  private  scala.collection.mutable.ArrayBuffer<scala.Tuple2<org.apache.spark.sql.execution.ScalarSubquery, scala.concurrent.Future<org.apache.spark.sql.catalyst.InternalRow[]>>> subqueryResults ()  { throw new RuntimeException(); }
  /**
   * Finds scalar subquery expressions in this plan node and starts evaluating them.
   * The list of subqueries are added to {@link subqueryResults}.
   */
