 ...
 * key-value stores, etc). Use {@link SparkSession.readStream} to access this.
 * <p>
 * @since 2.0.0
 */
public final class DataStreamReader implements org.apache.spark.internal.Logging {
  ...
  /**
   * Loads input data stream in as a {@link DataFrame}, for data streams that don't require a path
