...
public  class LogicalRelation extends org.apache.spark.sql.catalyst.plans.logical.LeafNode implements org.apache.spark.sql.catalyst.analysis.MultiInstanceRelation, scala.Product, scala.Serializable {
  ...
  // not preceding
  public   LogicalRelation (org.apache.spark.sql.sources.BaseRelation relation, scala.Option<scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Attribute>> expectedOutputAttributes, scala.Option<org.apache.spark.sql.catalyst.TableIdentifier> metastoreTableIdentifier)  { throw new RuntimeException(); }
