 ...
 * key-value stores, etc). Use {@link Dataset.writeStream} to access this.
 * <p>
 * @since 2.0.0
 */
public final class DataStreamWriter<T extends java.lang.Object> {
   ...
   * {@link ForeachWriter} as as new data arrives. The {@link ForeachWriter} can be used to send the data
   * generated by the {@link DataFrame}/{@link Dataset} to an external system.
   * <p>
   * Scala example:
   * <pre><code>
