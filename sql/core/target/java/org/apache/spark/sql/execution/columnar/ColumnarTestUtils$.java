...
public  class ColumnarTestUtils$ {
  ...
  public <T extends org.apache.spark.sql.types.AtomicType> scala.Tuple2<scala.collection.Seq<java.lang.Object>, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.GenericMutableRow>> makeUniqueValuesAndSingleValueRows (org.apache.spark.sql.execution.columnar.NativeColumnType<T> columnType, int count)  { throw new RuntimeException(); }
}
