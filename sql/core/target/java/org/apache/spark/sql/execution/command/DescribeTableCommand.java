...
public  class DescribeTableCommand extends org.apache.spark.sql.catalyst.plans.logical.LeafNode implements org.apache.spark.sql.execution.command.RunnableCommand, scala.Product, scala.Serializable {
  ...
  private  void describeDetailedPartitionInfo (org.apache.spark.sql.catalyst.catalog.SessionCatalog catalog, org.apache.spark.sql.catalyst.catalog.CatalogTable metadata, scala.collection.mutable.ArrayBuffer<org.apache.spark.sql.Row> result)  { throw new RuntimeException(); }
  ...
  private  void describeSchema (scala.collection.Seq<org.apache.spark.sql.catalyst.catalog.CatalogColumn> schema, scala.collection.mutable.ArrayBuffer<org.apache.spark.sql.Row> buffer)  { throw new RuntimeException(); }
