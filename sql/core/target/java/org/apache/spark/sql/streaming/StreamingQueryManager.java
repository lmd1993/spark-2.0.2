...
/**
 * :: Experimental ::
 * A class to manage all the {@link StreamingQuery} active on a {@link SparkSession}.
 * <p>
 * @since 2.0.0
 */
public  class StreamingQueryManager {
  ...
  private  scala.collection.mutable.HashMap<java.lang.Object, org.apache.spark.sql.streaming.StreamingQuery> activeQueries ()  { throw new RuntimeException(); }
   ...
   * @return (undocumented)
   */
  public  org.apache.spark.sql.streaming.StreamingQuery get (long id)  { throw new RuntimeException(); }
  /**
   ...
   * @since 2.0.0
   */
  public  void awaitAnyTermination ()  { throw new RuntimeException(); }
  /**
   * Wait until any of the queries on the associated SQLContext has terminated since the
   ...
   * @return (undocumented)
   */
  public  boolean awaitAnyTermination (long timeoutMs)  { throw new RuntimeException(); }
  /**
