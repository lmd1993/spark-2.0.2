...
public  class SQLContext implements org.apache.spark.internal.Logging, scala.Serializable {
  ...
  */
   ...
   * tables, registered functions, but sharing the same {@link SparkContext}, cached data and
   * other things.
   * <p>
   * @since 1.6.0
   * @return (undocumented)
  ...
  public  java.lang.String[] tableNames (java.lang.String databaseName)  { throw new RuntimeException(); }
    org.apache.spark.sql.types.DataType parseDataType (java.lang.String dataTypeString)  { throw new RuntimeException(); }
  /**
