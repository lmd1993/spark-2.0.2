 ...
 */
public  class IncrementalExecution extends org.apache.spark.sql.execution.QueryExecution {
  ...
  // not preceding
  public   IncrementalExecution (org.apache.spark.sql.SparkSession sparkSession, org.apache.spark.sql.catalyst.plans.logical.LogicalPlan logicalPlan, org.apache.spark.sql.streaming.OutputMode outputMode, java.lang.String checkpointLocation, long currentBatchId)  { throw new RuntimeException(); }
