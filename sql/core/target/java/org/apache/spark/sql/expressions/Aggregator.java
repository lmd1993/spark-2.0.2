...
/**
 * :: Experimental ::
 * A base class for user-defined aggregations, which can be used in {@link Dataset} operations to take
...
public abstract class Aggregator<IN extends java.lang.Object, BUF extends java.lang.Object, OUT extends java.lang.Object> implements scala.Serializable {
  ...
  /**
   * Specifies the {@link Encoder} for the intermediate value type.
   * @since 2.0.0
   * @return (undocumented)
   */
  public abstract  org.apache.spark.sql.Encoder<BUF> bufferEncoder ()  ;
  /**
   * Specifies the {@link Encoder} for the final ouput value type.
   * @since 2.0.0
   * @return (undocumented)
   */
  public abstract  org.apache.spark.sql.Encoder<OUT> outputEncoder ()  ;
  /**
   * Returns this <code>Aggregator</code> as a {@link TypedColumn} that can be used in {@link Dataset}.
   * operations.
   * @since 1.6.0
   * @return (undocumented)
   */
