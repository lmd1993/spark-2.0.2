 ...
 */
public  class CreateTableUsing extends org.apache.spark.sql.catalyst.plans.logical.LeafNode implements org.apache.spark.sql.catalyst.plans.logical.Command, scala.Product, scala.Serializable {
  ...
  // not preceding
  public   CreateTableUsing (org.apache.spark.sql.catalyst.TableIdentifier tableIdent, scala.Option<org.apache.spark.sql.types.StructType> userSpecifiedSchema, java.lang.String provider, boolean temporary, scala.collection.immutable.Map<java.lang.String, java.lang.String> options, java.lang.String[] partitionColumns, scala.Option<org.apache.spark.sql.execution.datasources.BucketSpec> bucketSpec, boolean allowExisting, boolean managedIfNoPath)  { throw new RuntimeException(); }
}
