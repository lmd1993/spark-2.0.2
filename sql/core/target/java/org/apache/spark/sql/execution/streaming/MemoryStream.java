...
public  class MemoryStream<A extends java.lang.Object> implements org.apache.spark.sql.execution.streaming.Source, org.apache.spark.internal.Logging, scala.Product, scala.Serializable {
  ...
  public  org.apache.spark.sql.Dataset<A> toDS (org.apache.spark.sql.SQLContext sqlContext)  { throw new RuntimeException(); }
  public  org.apache.spark.sql.Dataset<org.apache.spark.sql.Row> toDF (org.apache.spark.sql.SQLContext sqlContext)  { throw new RuntimeException(); }
