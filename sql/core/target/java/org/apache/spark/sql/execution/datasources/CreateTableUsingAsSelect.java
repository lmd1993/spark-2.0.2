 ...
 */
public  class CreateTableUsingAsSelect extends org.apache.spark.sql.catalyst.plans.logical.LeafNode implements org.apache.spark.sql.catalyst.plans.logical.Command, scala.Product, scala.Serializable {
  ...
  // not preceding
  public   CreateTableUsingAsSelect (org.apache.spark.sql.catalyst.TableIdentifier tableIdent, java.lang.String provider, java.lang.String[] partitionColumns, scala.Option<org.apache.spark.sql.execution.datasources.BucketSpec> bucketSpec, org.apache.spark.sql.SaveMode mode, scala.collection.immutable.Map<java.lang.String, java.lang.String> options, org.apache.spark.sql.catalyst.plans.logical.LogicalPlan query)  { throw new RuntimeException(); }
