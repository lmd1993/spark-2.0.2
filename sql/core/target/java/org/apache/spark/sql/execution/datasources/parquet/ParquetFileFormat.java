...
public  class ParquetFileFormat implements org.apache.spark.sql.execution.datasources.FileFormat, org.apache.spark.sql.sources.DataSourceRegister, org.apache.spark.internal.Logging, scala.Serializable {
  ...
  public  org.apache.spark.sql.execution.datasources.OutputWriterFactory buildWriter (org.apache.spark.sql.SQLContext sqlContext, org.apache.spark.sql.types.StructType dataSchema, scala.collection.immutable.Map<java.lang.String, java.lang.String> options)  { throw new RuntimeException(); }
}
