 ...
 */
public  class StateStoreSaveExec extends org.apache.spark.sql.execution.SparkPlan implements org.apache.spark.sql.execution.UnaryExecNode, org.apache.spark.sql.execution.streaming.StatefulOperator, scala.Product, scala.Serializable {
  ...
  static protected  scala.Function1<org.apache.spark.sql.catalyst.InternalRow, java.lang.Object> newPredicate (org.apache.spark.sql.catalyst.expressions.Expression expression, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Attribute> inputSchema)  { throw new RuntimeException(); }
  ...
  public  scala.Option<java.lang.Object> returnAllStates ()  { throw new RuntimeException(); }
  public  org.apache.spark.sql.execution.SparkPlan child ()  { throw new RuntimeException(); }
  // not preceding
  public   StateStoreSaveExec (scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Attribute> keyExpressions, scala.Option<org.apache.spark.sql.execution.streaming.OperatorStateId> stateId, scala.Option<java.lang.Object> returnAllStates, org.apache.spark.sql.execution.SparkPlan child)  { throw new RuntimeException(); }
   ...
   * @return (undocumented)
   */
  private  scala.collection.Iterator<org.apache.spark.sql.catalyst.InternalRow> saveAndReturnUpdated (org.apache.spark.sql.execution.streaming.state.StateStore store, scala.collection.Iterator<org.apache.spark.sql.catalyst.InternalRow> iter)  { throw new RuntimeException(); }
  /**
   * Save all the rows to the state store, and return all the rows in the state store.
   ...
   * @return (undocumented)
   */
  private  scala.collection.Iterator<org.apache.spark.sql.catalyst.InternalRow> saveAndReturnAll (org.apache.spark.sql.execution.streaming.state.StateStore store, scala.collection.Iterator<org.apache.spark.sql.catalyst.InternalRow> iter)  { throw new RuntimeException(); }
}
