...
public  class FindDataSourceTable extends org.apache.spark.sql.catalyst.rules.Rule<org.apache.spark.sql.catalyst.plans.logical.LogicalPlan> {
  ...
  private  org.apache.spark.sql.catalyst.plans.logical.LogicalPlan readDataSourceTable (org.apache.spark.sql.SparkSession sparkSession, org.apache.spark.sql.catalyst.catalog.CatalogTable table)  { throw new RuntimeException(); }
