...
public  class FileSourceStrategy {
  ...
  static private  org.apache.hadoop.fs.BlockLocation[] getBlockLocations (org.apache.hadoop.fs.FileStatus file)  { throw new RuntimeException(); }
  static private  java.lang.String[] getBlockHosts (org.apache.hadoop.fs.BlockLocation[] blockLocations, long offset, long length)  { throw new RuntimeException(); }
