...
public  class CreateViewCommand extends org.apache.spark.sql.catalyst.plans.logical.LeafNode implements org.apache.spark.sql.execution.command.RunnableCommand, scala.Product, scala.Serializable {
  ...
  // not preceding
  public   CreateViewCommand (org.apache.spark.sql.catalyst.catalog.CatalogTable tableDesc, org.apache.spark.sql.catalyst.plans.logical.LogicalPlan child, boolean allowExisting, boolean replace, boolean isTemporary)  { throw new RuntimeException(); }
  ...
  private  void createTemporaryView (org.apache.spark.sql.catalyst.TableIdentifier table, org.apache.spark.sql.SparkSession sparkSession, org.apache.spark.sql.catalyst.plans.logical.LogicalPlan analyzedPlan)  { throw new RuntimeException(); }
  /**
   * Returns a {@link CatalogTable} that can be used to save in the catalog. This comment canonicalize
   * SQL based on the analyzed plan, and also creates the proper schema for the view.
   * @param sparkSession (undocumented)
   * @param analyzedPlan (undocumented)
   * @return (undocumented)
   */
  private  org.apache.spark.sql.catalyst.catalog.CatalogTable prepareTable (org.apache.spark.sql.SparkSession sparkSession, org.apache.spark.sql.catalyst.plans.logical.LogicalPlan analyzedPlan)  { throw new RuntimeException(); }
  /** Escape backtick with double-backtick in column name and wrap it with backtick. */
  private  java.lang.String quote (java.lang.String name)  { throw new RuntimeException(); }
}
