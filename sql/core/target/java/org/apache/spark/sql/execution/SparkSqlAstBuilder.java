...
public  class SparkSqlAstBuilder extends org.apache.spark.sql.catalyst.parser.AstBuilder {
  ...
  /**
   * Create an {@link AnalyzeTableCommand} command. This currently only implements the NOSCAN
  ...
  /**
   * Create a {@link CreateTableUsing} or a {@link CreateTableUsingAsSelect} logical plan.
   * <p>
   ...
   * @return (undocumented)
   */
  public  org.apache.spark.sql.execution.datasources.BucketSpec visitBucketSpec (org.apache.spark.sql.catalyst.parser.SqlBaseParser.BucketSpecContext ctx)  { throw new RuntimeException(); }
  /**
  ...
  /**
   * Create a table, returning either a {@link CreateTableCommand} or a
   * {@link CreateHiveTableAsSelectLogicalPlan}.
   * <p>
  ...
  /**
   * Create a sequence of {@link CatalogColumn}s from a column list
   * @param ctx (undocumented)
   * @return (undocumented)
   */
  private  scala.collection.Seq<org.apache.spark.sql.catalyst.catalog.CatalogColumn> visitCatalogColumns (org.apache.spark.sql.catalyst.parser.SqlBaseParser.ColTypeListContext ctx)  { throw new RuntimeException(); }
  /**
