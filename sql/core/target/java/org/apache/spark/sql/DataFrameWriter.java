 ...
 * key-value stores, etc). Use {@link Dataset.write} to access this.
 * <p>
 * @since 1.4.0
 */
public final class DataFrameWriter<T extends java.lang.Object> {
  ...
  private  scala.Option<org.apache.spark.sql.execution.datasources.BucketSpec> getBucketSpec ()  { throw new RuntimeException(); }
  /**
   ...
   * the existing table. The column order in the schema of the {@link DataFrame} doesn't need to be same
  ...
  /**
   * Saves the content of the {@link DataFrame} to an external database table via JDBC. In the case the
