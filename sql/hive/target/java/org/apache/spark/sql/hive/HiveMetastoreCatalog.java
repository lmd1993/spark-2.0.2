 ...
 */
  ...
  private  org.apache.spark.sql.hive.HiveMetastoreCatalog.QualifiedTableName getQualifiedTableName (org.apache.spark.sql.catalyst.catalog.CatalogTable t)  { throw new RuntimeException(); }
  ...
  private  scala.Option<org.apache.spark.sql.execution.datasources.LogicalRelation> getCached (org.apache.spark.sql.hive.HiveMetastoreCatalog.QualifiedTableName tableIdentifier, scala.collection.Seq<java.lang.String> pathsInMetastore, org.apache.spark.sql.hive.MetastoreRelation metastoreRelation, org.apache.spark.sql.types.StructType schemaInMetastore, java.lang.Class<? extends org.apache.spark.sql.execution.datasources.FileFormat> expectedFileFormat, scala.Option<org.apache.spark.sql.execution.datasources.BucketSpec> expectedBucketSpec, scala.Option<org.apache.spark.sql.execution.datasources.PartitionSpec> partitionSpecInMetastore)  { throw new RuntimeException(); }
