 ...
 */
public  class CollectList extends org.apache.spark.sql.catalyst.expressions.aggregate.Collect implements scala.Product, scala.Serializable {
  ...
  static public  org.apache.spark.sql.types.StructType aggBufferSchema ()  { throw new RuntimeException(); }
  static public  scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.AttributeReference> inputAggBufferAttributes ()  { throw new RuntimeException(); }
  static public  boolean deterministic ()  { throw new RuntimeException(); }
  static public  void initialize (org.apache.spark.sql.catalyst.expressions.MutableRow b)  { throw new RuntimeException(); }
  static public  void update (org.apache.spark.sql.catalyst.expressions.MutableRow b, org.apache.spark.sql.catalyst.InternalRow input)  { throw new RuntimeException(); }
  static public  void merge (org.apache.spark.sql.catalyst.expressions.MutableRow buffer, org.apache.spark.sql.catalyst.InternalRow input)  { throw new RuntimeException(); }
  ...
  protected  scala.collection.mutable.ArrayBuffer<java.lang.Object> buffer ()  { throw new RuntimeException(); }
}
