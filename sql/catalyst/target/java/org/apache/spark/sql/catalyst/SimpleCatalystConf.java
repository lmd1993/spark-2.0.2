...
public  class SimpleCatalystConf implements org.apache.spark.sql.catalyst.CatalystConf, scala.Product, scala.Serializable {
  ...
  // not preceding
  public   SimpleCatalystConf (boolean caseSensitiveAnalysis, boolean orderByOrdinal, boolean groupByOrdinal, int optimizerMaxIterations, int optimizerInSetConversionThreshold, int maxCaseBranchesForCodegen, boolean runSQLonFile, java.lang.String warehousePath)  { throw new RuntimeException(); }
}
