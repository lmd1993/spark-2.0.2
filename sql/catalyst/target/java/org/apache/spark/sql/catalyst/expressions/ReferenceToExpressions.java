...
/**
 * A special expression that evaluates {@link BoundReference}s by given expressions instead of the
 * input row.
 * <p>
 * param:  result The expression that contains {@link BoundReference} and produces the final output.
 * param:  children The expressions that used as input values for {@link BoundReference}.
 */
public  class ReferenceToExpressions extends org.apache.spark.sql.catalyst.expressions.Expression implements scala.Product, scala.Serializable {
  ...
  // not preceding
  public   ReferenceToExpressions (org.apache.spark.sql.catalyst.expressions.Expression result, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Expression> children)  { throw new RuntimeException(); }
