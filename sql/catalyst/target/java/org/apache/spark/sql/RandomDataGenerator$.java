...
public  class RandomDataGenerator$ {
   ...
   * @return (undocumented)
   */
  private  float PROBABILITY_OF_INTERESTING_VALUE ()  { throw new RuntimeException(); }
  /**
   * The probability of the generated value being null
   * @return (undocumented)
   */
  private  float PROBABILITY_OF_NULL ()  { throw new RuntimeException(); }
   ...
   * @return (undocumented)
   */
  private <T extends java.lang.Object> scala.Some<scala.Function0<T>> randomNumeric (scala.util.Random rand, scala.Function1<scala.util.Random, T> uniformRand, scala.collection.Seq<T> interestingValues)  { throw new RuntimeException(); }
  /**
   ...
   */
  public  scala.Option<scala.Function0<java.lang.Object>> forType (org.apache.spark.sql.types.DataType dataType, boolean nullable, scala.util.Random rand)  { throw new RuntimeException(); }
