...
/**
 * A {@link LogicalPlan} that wraps {@link CatalogTable}.
 * <p>
 * Note that in the future we should consolidate this and HiveCatalogRelation.
 */
public  class SimpleCatalogRelation extends org.apache.spark.sql.catalyst.plans.logical.LeafNode implements org.apache.spark.sql.catalyst.catalog.CatalogRelation, scala.Product, scala.Serializable {
  ...
  public  org.apache.spark.sql.catalyst.catalog.CatalogTable metadata ()  { throw new RuntimeException(); }
  public  scala.Option<java.lang.String> alias ()  { throw new RuntimeException(); }
  // not preceding
  public   SimpleCatalogRelation (java.lang.String databaseName, org.apache.spark.sql.catalyst.catalog.CatalogTable metadata, scala.Option<java.lang.String> alias)  { throw new RuntimeException(); }
