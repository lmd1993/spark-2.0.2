...
public  class TypeCoercionSuite extends org.apache.spark.sql.catalyst.plans.PlanTest {
  ...
  private  void ruleTest (org.apache.spark.sql.catalyst.rules.Rule<org.apache.spark.sql.catalyst.plans.logical.LogicalPlan> rule, org.apache.spark.sql.catalyst.expressions.Expression initial, org.apache.spark.sql.catalyst.expressions.Expression transformed)  { throw new RuntimeException(); }
  private  void ruleTest (scala.collection.Seq<org.apache.spark.sql.catalyst.rules.Rule<org.apache.spark.sql.catalyst.plans.logical.LogicalPlan>> rules, org.apache.spark.sql.catalyst.expressions.Expression initial, org.apache.spark.sql.catalyst.expressions.Expression transformed)  { throw new RuntimeException(); }
  private  void checkOutput (org.apache.spark.sql.catalyst.plans.logical.LogicalPlan logical, scala.collection.Seq<org.apache.spark.sql.types.DataType> expectTypes)  { throw new RuntimeException(); }
}
