 ...
 * {@link PredicateSubquery} expressions within a Filter plan (i.e. WHERE or a HAVING clause). This will
 * be rewritten into a left semi/anti join during analysis.
 */
public  class PredicateSubquery extends org.apache.spark.sql.catalyst.expressions.SubqueryExpression implements org.apache.spark.sql.catalyst.expressions.Predicate, org.apache.spark.sql.catalyst.expressions.Unevaluable, scala.Product, scala.Serializable {
  static public  boolean hasPredicateSubquery (org.apache.spark.sql.catalyst.expressions.Expression e)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  static public  boolean hasNullAwarePredicateWithinNot (org.apache.spark.sql.catalyst.expressions.Expression e)  { throw new RuntimeException(); }
  ...
  public  boolean nullAware ()  { throw new RuntimeException(); }
  public  org.apache.spark.sql.catalyst.expressions.ExprId exprId ()  { throw new RuntimeException(); }
  // not preceding
  public   PredicateSubquery (org.apache.spark.sql.catalyst.plans.logical.LogicalPlan query, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Expression> children, boolean nullAware, org.apache.spark.sql.catalyst.expressions.ExprId exprId)  { throw new RuntimeException(); }
  ...
  public  org.apache.spark.sql.catalyst.expressions.PredicateSubquery withNewPlan (org.apache.spark.sql.catalyst.plans.logical.LogicalPlan plan)  { throw new RuntimeException(); }
