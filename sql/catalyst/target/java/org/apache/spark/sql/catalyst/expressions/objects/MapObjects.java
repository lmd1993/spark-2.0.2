...
public  class MapObjects extends org.apache.spark.sql.catalyst.expressions.Expression implements org.apache.spark.sql.catalyst.expressions.NonSQLExpression, scala.Product, scala.Serializable {
   ...
   * @return (undocumented)
   */
  static public  org.apache.spark.sql.catalyst.expressions.objects.MapObjects apply (scala.Function1<org.apache.spark.sql.catalyst.expressions.Expression, org.apache.spark.sql.catalyst.expressions.Expression> function, org.apache.spark.sql.catalyst.expressions.Expression inputData, org.apache.spark.sql.types.DataType elementType)  { throw new RuntimeException(); }
  ...
  // not preceding
  private   MapObjects (java.lang.String loopValue, java.lang.String loopIsNull, org.apache.spark.sql.types.DataType loopVarDataType, org.apache.spark.sql.catalyst.expressions.Expression lambdaFunction, org.apache.spark.sql.catalyst.expressions.Expression inputData)  { throw new RuntimeException(); }
