...
public abstract class TreeNode<BaseType extends org.apache.spark.sql.catalyst.trees.TreeNode<BaseType>> implements scala.Product {
  static public <BaseType extends org.apache.spark.sql.catalyst.trees.TreeNode<BaseType>> BaseType fromJSON (java.lang.String json, org.apache.spark.SparkContext sc)  { throw new RuntimeException(); }
  static private  org.apache.spark.sql.catalyst.trees.TreeNode<?> reconstruct (org.json4s.JsonAST.JArray treeNodeJson, org.apache.spark.SparkContext sc)  { throw new RuntimeException(); }
  static private  java.lang.Object parseFromJson (org.json4s.JsonAST.JValue value, org.apache.spark.sql.catalyst.ScalaReflection.universe expectedType, scala.collection.Seq<org.apache.spark.sql.catalyst.trees.TreeNode<?>> children, org.apache.spark.SparkContext sc)  { throw new RuntimeException(); }
  static private  java.lang.Object parseToProduct (java.lang.String clsName, scala.collection.Seq<scala.Tuple2<java.lang.String, scala.reflect.api.Types.TypeApi>> fields, org.json4s.JsonAST.JValue value, scala.collection.Seq<org.apache.spark.sql.catalyst.trees.TreeNode<?>> children, org.apache.spark.SparkContext sc)  { throw new RuntimeException(); }
  static private  boolean isScalaObject (org.json4s.JsonAST.JValue jValue)  { throw new RuntimeException(); }
  static private  boolean isScalaProduct (org.json4s.JsonAST.JValue jValue)  { throw new RuntimeException(); }
