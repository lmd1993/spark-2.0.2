 ...
 */
public abstract class SubqueryExpression extends org.apache.spark.sql.catalyst.expressions.Expression {
  ...
  public abstract  org.apache.spark.sql.catalyst.plans.logical.LogicalPlan query ()  ;
  /**
   * Either a logical plan or a physical plan. The generated tree string (explain output) uses this
   * field to explain the subquery.
   * @return (undocumented)
   */
  public abstract  org.apache.spark.sql.catalyst.plans.QueryPlan<?> plan ()  ;
