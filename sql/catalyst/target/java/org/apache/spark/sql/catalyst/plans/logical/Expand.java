...
public  class Expand extends org.apache.spark.sql.catalyst.plans.logical.UnaryNode implements scala.Product, scala.Serializable {
   ...
   */
  static private  org.apache.spark.sql.catalyst.expressions.AttributeSet buildNonSelectAttrSet (int bitmask, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Attribute> attrs)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  static public  org.apache.spark.sql.catalyst.plans.logical.Expand apply (scala.collection.Seq<java.lang.Object> bitmasks, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Alias> groupByAliases, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Attribute> groupByAttrs, org.apache.spark.sql.catalyst.expressions.Attribute gid, org.apache.spark.sql.catalyst.plans.logical.LogicalPlan child)  { throw new RuntimeException(); }
