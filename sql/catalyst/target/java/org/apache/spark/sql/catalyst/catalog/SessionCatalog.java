...
public  class SessionCatalog implements org.apache.spark.internal.Logging {
  ...
  public   SessionCatalog (org.apache.spark.sql.catalyst.catalog.ExternalCatalog externalCatalog, org.apache.spark.sql.catalyst.catalog.FunctionResourceLoader functionResourceLoader, org.apache.spark.sql.catalyst.analysis.FunctionRegistry functionRegistry, org.apache.spark.sql.catalyst.CatalystConf conf, org.apache.hadoop.conf.Configuration hadoopConf)  { throw new RuntimeException(); }
   ...
   * @param isSkewedStoreAsSubdir (undocumented)
   */
  public  void loadPartition (org.apache.spark.sql.catalyst.TableIdentifier name, java.lang.String loadPath, scala.collection.immutable.Map<java.lang.String, java.lang.String> partition, boolean isOverwrite, boolean holdDDLTime, boolean inheritTableSpecs, boolean isSkewedStoreAsSubdir)  { throw new RuntimeException(); }
   ...
   * @param name (undocumented)
   */
  public  void dropTempView (java.lang.String name)  { throw new RuntimeException(); }
  /**
   ...
   * <p>
   * This assumes the database specified in <code>oldName</code> matches the one specified in <code>newName</code>.
   ...
   */
  public  void dropTable (org.apache.spark.sql.catalyst.TableIdentifier name, boolean ignoreIfNotExists)  { throw new RuntimeException(); }
  /**
   * Return a {@link LogicalPlan} that represents the given table.
   * <p>
   * If a database is specified in <code>name</code>, this will return the table from that database.
   ...
   * @param ignoreIfNotExists (undocumented)
   */
  public  void dropPartitions (org.apache.spark.sql.catalyst.TableIdentifier tableName, scala.collection.Seq<scala.collection.immutable.Map<java.lang.String, java.lang.String>> specs, boolean ignoreIfNotExists)  { throw new RuntimeException(); }
  /**
