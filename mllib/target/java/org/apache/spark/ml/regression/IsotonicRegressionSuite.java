...
public  class IsotonicRegressionSuite extends org.apache.spark.SparkFunSuite implements org.apache.spark.mllib.util.MLlibTestSparkContext, org.apache.spark.ml.util.DefaultReadWriteTest {
  /**
  ...
  private  org.apache.spark.sql.Dataset<org.apache.spark.sql.Row> generateIsotonicInput (scala.collection.Seq<java.lang.Object> labels)  { throw new RuntimeException(); }
  private  org.apache.spark.sql.Dataset<org.apache.spark.sql.Row> generatePredictionInput (scala.collection.Seq<java.lang.Object> features)  { throw new RuntimeException(); }
}
