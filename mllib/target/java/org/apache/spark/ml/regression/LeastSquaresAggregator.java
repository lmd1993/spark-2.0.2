...
public  class LeastSquaresAggregator implements scala.Serializable {
  public   LeastSquaresAggregator (org.apache.spark.ml.linalg.Vector coefficients, double labelStd, double labelMean, boolean fitIntercept, double[] featuresStd, double[] featuresMean)  { throw new RuntimeException(); }
