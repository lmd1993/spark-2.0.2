...
public  class LogisticCostFun implements breeze.optimize.DiffFunction<breeze.linalg.DenseVector<java.lang.Object>> {
  public   LogisticCostFun (org.apache.spark.rdd.RDD<org.apache.spark.ml.feature.Instance> instances, int numClasses, boolean fitIntercept, boolean standardization, double[] featuresStd, double[] featuresMean, double regParamL2)  { throw new RuntimeException(); }
