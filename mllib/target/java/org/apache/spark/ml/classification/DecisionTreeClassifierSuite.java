...
public  class DecisionTreeClassifierSuite extends org.apache.spark.SparkFunSuite implements org.apache.spark.mllib.util.MLlibTestSparkContext, org.apache.spark.ml.util.DefaultReadWriteTest {
  /**
  ...
  private  org.apache.spark.rdd.RDD<org.apache.spark.ml.feature.LabeledPoint> categoricalDataPointsRDD ()  { throw new RuntimeException(); }
  private  org.apache.spark.rdd.RDD<org.apache.spark.ml.feature.LabeledPoint> orderedLabeledPointsWithLabel0RDD ()  { throw new RuntimeException(); }
  private  org.apache.spark.rdd.RDD<org.apache.spark.ml.feature.LabeledPoint> orderedLabeledPointsWithLabel1RDD ()  { throw new RuntimeException(); }
  private  org.apache.spark.rdd.RDD<org.apache.spark.ml.feature.LabeledPoint> categoricalDataPointsForMulticlassRDD ()  { throw new RuntimeException(); }
  private  org.apache.spark.rdd.RDD<org.apache.spark.ml.feature.LabeledPoint> continuousDataPointsForMulticlassRDD ()  { throw new RuntimeException(); }
  private  org.apache.spark.rdd.RDD<org.apache.spark.ml.feature.LabeledPoint> categoricalDataPointsForMulticlassForOrderedFeaturesRDD ()  { throw new RuntimeException(); }
