 ...
 * categorical features. The number of bins can be set using the <code>numBuckets</code> parameter.
 * The bin ranges are chosen using an approximate algorithm (see the documentation for
 * {@link org.apache.spark.sql.DataFrameStatFunctions.approxQuantile approxQuantile}
