...
public  class IndexedRowMatrix implements org.apache.spark.mllib.linalg.distributed.DistributedMatrix {
  ...
  /** Converts to BlockMatrix. Creates blocks of {@link SparseMatrix} with size 1024 x 1024. */
  public  org.apache.spark.mllib.linalg.distributed.BlockMatrix toBlockMatrix ()  { throw new RuntimeException(); }
  /**
   * Converts to BlockMatrix. Creates blocks of {@link SparseMatrix}.
  ...
  /**
   * Computes the Gramian matrix <code>A^T A</code>. Note that this cannot be
