...
public  class BlockMatrix implements org.apache.spark.mllib.linalg.distributed.DistributedMatrix, org.apache.spark.internal.Logging {
   ...
   * values. If one of the blocks that are being added are instances of {@link SparseMatrix},
   * the resulting sub matrix will also be a {@link SparseMatrix}, even if it is being added
   * to a {@link DenseMatrix}. If two dense matrices are added, the output will also be a
   * {@link DenseMatrix}.
   ...
   * The matrices must have the same size and matching <code>rowsPerBlock</code> and <code>colsPerBlock</code>
   * values. If one of the blocks that are being subtracted are instances of {@link SparseMatrix},
   * the resulting sub matrix will also be a {@link SparseMatrix}, even if it is being subtracted
   * from a {@link DenseMatrix}. If two dense matrices are subtracted, the output will also be a
   * {@link DenseMatrix}.
   * @param other (undocumented)
   * @return (undocumented)
   */
