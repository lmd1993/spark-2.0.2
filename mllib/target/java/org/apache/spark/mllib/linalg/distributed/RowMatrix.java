...
public  class RowMatrix implements org.apache.spark.mllib.linalg.distributed.DistributedMatrix, org.apache.spark.internal.Logging {
  ...
  /**
   * Computes the Gramian matrix <code>A^T A</code>. Note that this cannot be computed on matrices with
   ...
   *  architectures"  ({@link http://dx.doi.org/10.1145/1996092.1996103})
   * <p>
