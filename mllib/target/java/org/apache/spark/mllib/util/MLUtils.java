...
public  class MLUtils {
   ...
   * @return the input {@link DataFrame} with old vector columns converted to the new vector type
   */
   ...
   * @return the input {@link DataFrame} with new vector columns converted to the old vector type
   */
   ...
   * @return the input {@link DataFrame} with old matrix columns converted to the new matrix type
   */
   ...
   * @return the input {@link DataFrame} with new matrix columns converted to the old matrix type
   */
  ...
  /**
   * Version of {@link kFold()} taking a Long seed.
   * @param rdd (undocumented)
   * @param numFolds (undocumented)
   * @param seed (undocumented)
