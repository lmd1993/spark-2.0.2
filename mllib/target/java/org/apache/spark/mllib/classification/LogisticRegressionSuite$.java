...
public  class LogisticRegressionSuite$ implements scala.Serializable {
  ...
  private  org.apache.spark.mllib.classification.LogisticRegressionModel binaryModel ()  { throw new RuntimeException(); }
  /** 3 classes, 2 features */
  private  org.apache.spark.mllib.classification.LogisticRegressionModel multiclassModel ()  { throw new RuntimeException(); }
  private  void checkModelsEqual (org.apache.spark.mllib.classification.LogisticRegressionModel a, org.apache.spark.mllib.classification.LogisticRegressionModel b)  { throw new RuntimeException(); }
}
