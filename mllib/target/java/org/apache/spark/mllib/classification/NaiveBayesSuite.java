...
public  class NaiveBayesSuite extends org.apache.spark.SparkFunSuite implements org.apache.spark.mllib.util.MLlibTestSparkContext {
  ...
  static private  org.apache.spark.mllib.classification.NaiveBayesModel binaryBernoulliModel ()  { throw new RuntimeException(); }
  /** Multinomial NaiveBayes with binary labels, 3 features */
  static private  org.apache.spark.mllib.classification.NaiveBayesModel binaryMultinomialModel ()  { throw new RuntimeException(); }
   ...
   */
  private  double[] expectedMultinomialProbabilities (org.apache.spark.mllib.classification.NaiveBayesModel model, org.apache.spark.mllib.linalg.Vector testData)  { throw new RuntimeException(); }
  /**
   * @param model Bernoulli Naive Bayes model
   * @param testData input to compute posterior probabilities for
   * @return posterior class probabilities (in order of labels) for input
   */
  private  double[] expectedBernoulliProbabilities (org.apache.spark.mllib.classification.NaiveBayesModel model, org.apache.spark.mllib.linalg.Vector testData)  { throw new RuntimeException(); }
}
