...
public  class NaiveBayes$ implements scala.Serializable {
   ...
   * <p>
   * This is the default Multinomial NB ({@link http://tinyurl.com/lsdw6p}) which can handle all
   ...
   * Trains a Naive Bayes model given an RDD of <code>(label, features)</code> pairs.
   * <p>
   * The model type can be set to either Multinomial NB ({@link http://tinyurl.com/lsdw6p})
   * or Bernoulli NB ({@link http://tinyurl.com/p7c96j6}). The Multinomial NB can handle
