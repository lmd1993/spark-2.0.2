 ...
 * <p>
 * @see {@link http://glaros.dtc.umn.edu/gkhome/fetch/papers/docclusterKDDTMW00.pdf
...
public  class BisectingKMeans implements org.apache.spark.internal.Logging {
  ...
  /**
   * Sets the minimum number of points (if >= <code>1.0</code>) or the minimum proportion of points
   * (if < <code>1.0</code>) of a divisible cluster (default: 1).
  ...
  /**
   * Gets the minimum number of points (if >= <code>1.0</code>) or the minimum proportion of points
   * (if < <code>1.0</code>) of a divisible cluster.
   * @return (undocumented)
   */
