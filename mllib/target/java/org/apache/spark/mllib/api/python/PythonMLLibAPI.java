 ...
 */
   ...
   * @return (undocumented)
   */
  public  org.apache.spark.mllib.clustering.BisectingKMeansModel trainBisectingKMeans (org.apache.spark.api.java.JavaRDD<org.apache.spark.mllib.linalg.Vector> data, int k, int maxIterations, double minDivisibleClusterSize, long seed)  { throw new RuntimeException(); }
  /**
   ...
   */
  public  org.apache.spark.mllib.api.python.Word2VecModelWrapper trainWord2VecModel (org.apache.spark.api.java.JavaRDD<java.util.ArrayList<java.lang.String>> dataJRDD, int vectorSize, double learningRate, int numPartitions, int numIterations, long seed, int minCount, int windowSize)  { throw new RuntimeException(); }
  /**
