 ...
 * Efficiently by Prefix-Projected Pattern Growth ({@link http://doi.org/10.1109/ICDE.2001.914830}).
 * <p>
 ...
 * <p>
 * @see {@link https://en.wikipedia.org/wiki/Sequential_Pattern_Mining Sequential Pattern Mining
 *       (Wikipedia)}
 */
public  class PrefixSpan implements org.apache.spark.internal.Logging, scala.Serializable {
  ...
  /**
   * A Java-friendly version of {@link run()} that reads sequences from a {@link JavaRDD} and returns
