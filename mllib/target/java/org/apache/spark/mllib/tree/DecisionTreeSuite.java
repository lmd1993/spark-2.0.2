...
public  class DecisionTreeSuite extends org.apache.spark.SparkFunSuite implements org.apache.spark.mllib.util.MLlibTestSparkContext {
  ...
  static private  org.apache.spark.mllib.tree.model.Node createLeafNode (int id)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  static private  org.apache.spark.mllib.tree.model.Node createInternalNode (int id, scala.Enumeration.Value featureType)  { throw new RuntimeException(); }
  /**
  ...
  static private  int[] createdModelNodeIds ()  { throw new RuntimeException(); }
  /**
   ...
   * @param b (undocumented)
   */
  static private  void checkEqual (org.apache.spark.mllib.tree.model.Node a, org.apache.spark.mllib.tree.model.Node b)  { throw new RuntimeException(); }
