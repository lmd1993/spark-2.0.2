...
public  class BlockManagerReplicationSuite extends org.apache.spark.SparkFunSuite implements org.scalatest.Matchers, org.scalatest.BeforeAndAfter, org.apache.spark.LocalSparkContext {
  ...
  private  org.apache.spark.broadcast.BroadcastManager bcastManager ()  { throw new RuntimeException(); }
  private  org.apache.spark.MapOutputTrackerMaster mapOutputTracker ()  { throw new RuntimeException(); }
  private  org.apache.spark.shuffle.sort.SortShuffleManager shuffleManager ()  { throw new RuntimeException(); }
