...
public  class BlockManagerSuite extends org.apache.spark.SparkFunSuite implements org.scalatest.Matchers, org.scalatest.BeforeAndAfterEach, org.scalatest.PrivateMethodTester, org.apache.spark.LocalSparkContext, org.apache.spark.util.ResetSystemProperties {
  ...
  static private  class BlockManagerTestUtils {
    public   BlockManagerTestUtils (org.apache.spark.storage.BlockManager store)  { throw new RuntimeException(); }
    public  void dropFromMemoryIfExists (org.apache.spark.storage.BlockId blockId, scala.Function0<scala.util.Either<java.lang.Object[], org.apache.spark.util.io.ChunkedByteBuffer>> data)  { throw new RuntimeException(); }
    private <T extends java.lang.Object> scala.Function1<org.apache.spark.storage.BlockId, scala.Option<T>> wrapGet (scala.Function1<org.apache.spark.storage.BlockId, scala.Option<T>> f)  { throw new RuntimeException(); }
    public  boolean hasLocalBlock (org.apache.spark.storage.BlockId blockId)  { throw new RuntimeException(); }
    public  scala.Function1<org.apache.spark.storage.BlockId, scala.Option<org.apache.spark.storage.BlockResult>> getLocalAndReleaseLock ()  { throw new RuntimeException(); }
    public  scala.Function1<org.apache.spark.storage.BlockId, scala.Option<org.apache.spark.storage.BlockResult>> getAndReleaseLock ()  { throw new RuntimeException(); }
    public  scala.Function1<org.apache.spark.storage.BlockId, scala.Option<java.lang.Object>> getSingleAndReleaseLock ()  { throw new RuntimeException(); }
    public  scala.Function1<org.apache.spark.storage.BlockId, scala.Option<org.apache.spark.util.io.ChunkedByteBuffer>> getLocalBytesAndReleaseLock ()  { throw new RuntimeException(); }
  }
  ...
  private  org.apache.spark.storage.BlockManager makeBlockManager (long maxMem, java.lang.String name, org.apache.spark.storage.BlockManagerMaster master, scala.Option<org.apache.spark.network.BlockTransferService> transferService)  { throw new RuntimeException(); }
  public  void beforeEach ()  { throw new RuntimeException(); }
  public  void afterEach ()  { throw new RuntimeException(); }
  private  void testInMemoryLRUStorage (org.apache.spark.storage.StorageLevel storageLevel)  { throw new RuntimeException(); }
  public  void testDiskAndMemoryStorage (org.apache.spark.storage.StorageLevel storageLevel, boolean getAsBytes)  { throw new RuntimeException(); }
  private  void testReadWithLossOfOnDiskFiles (org.apache.spark.storage.StorageLevel storageLevel, scala.Function1<org.apache.spark.storage.BlockManager, scala.Option<?>> readMethod)  { throw new RuntimeException(); }
}
