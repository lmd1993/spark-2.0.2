...
/**
 * An {@link RpcEndpoint} for remote {@link RpcEnv}s to query if an {@link RpcEndpoint} exists.
 * <p>
 ...
 */
  ...
  /** A message used to ask the remote {@link RpcEndpointVerifier} if an {@link RpcEndpoint} exists. */
