...
public  class TestRpcEndpoint implements org.apache.spark.rpc.ThreadSafeRpcEndpoint, org.scalactic.TripleEquals {
  ...
  private  scala.collection.mutable.ArrayBuffer<java.lang.Object> receiveMessages ()  { throw new RuntimeException(); }
  private  scala.collection.mutable.ArrayBuffer<java.lang.Object> receiveAndReplyMessages ()  { throw new RuntimeException(); }
  private  scala.collection.mutable.ArrayBuffer<org.apache.spark.rpc.RpcAddress> onConnectedMessages ()  { throw new RuntimeException(); }
  private  scala.collection.mutable.ArrayBuffer<org.apache.spark.rpc.RpcAddress> onDisconnectedMessages ()  { throw new RuntimeException(); }
  private  scala.collection.mutable.ArrayBuffer<scala.Tuple2<java.lang.Throwable, org.apache.spark.rpc.RpcAddress>> onNetworkErrorMessages ()  { throw new RuntimeException(); }
