...
public  class StaticMemoryManagerSuite extends org.apache.spark.SparkFunSuite implements org.apache.spark.memory.MemoryManagerSuite {
   ...
   * @return (undocumented)
   */
  private  scala.Tuple2<org.apache.spark.memory.StaticMemoryManager, org.apache.spark.storage.memory.MemoryStore> makeThings (long maxExecutionMem, long maxStorageMem)  { throw new RuntimeException(); }
