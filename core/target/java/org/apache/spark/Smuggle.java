...
public  class Smuggle<T extends java.lang.Object> implements scala.Serializable {
  ...
  static private  java.util.concurrent.locks.ReentrantReadWriteLock lock ()  { throw new RuntimeException(); }
  static private  scala.collection.mutable.WeakHashMap<scala.Symbol, java.lang.Object> smuggledObjects ()  { throw new RuntimeException(); }
  static private <T extends java.lang.Object> T get (scala.Symbol key)  { throw new RuntimeException(); }
  /**
  ...
  // not preceding
  private   Smuggle (scala.Symbol key)  { throw new RuntimeException(); }
