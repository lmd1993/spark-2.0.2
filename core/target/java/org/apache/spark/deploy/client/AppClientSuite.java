...
public  class AppClientSuite extends org.apache.spark.SparkFunSuite implements org.apache.spark.LocalSparkContext, org.scalatest.BeforeAndAfterAll, org.scalatest.concurrent.Eventually, org.scalatest.concurrent.ScalaFutures {
  ...
  private  class AppClientCollector implements org.apache.spark.deploy.client.StandaloneAppClientListener, org.apache.spark.internal.Logging {
    public   AppClientCollector ()  { throw new RuntimeException(); }
    public  java.util.concurrent.ConcurrentLinkedQueue<java.lang.String> connectedIdList ()  { throw new RuntimeException(); }
    public  int disconnectedCount ()  { throw new RuntimeException(); }
    public  java.util.concurrent.ConcurrentLinkedQueue<java.lang.String> deadReasonList ()  { throw new RuntimeException(); }
    public  java.util.concurrent.ConcurrentLinkedQueue<java.lang.String> execAddedList ()  { throw new RuntimeException(); }
    public  java.util.concurrent.ConcurrentLinkedQueue<java.lang.String> execRemovedList ()  { throw new RuntimeException(); }
    ...
    public  void executorRemoved (java.lang.String id, java.lang.String message, scala.Option<java.lang.Object> exitStatus, boolean workerLost)  { throw new RuntimeException(); }
  }
  ...
  private  class AppClientInst {
    ...
    public  org.apache.spark.deploy.client.StandaloneAppClient client ()  { throw new RuntimeException(); }
  }
}
