...
public  class DeployTestUtils {
  static public  org.apache.spark.deploy.ApplicationDescription createAppDesc ()  { throw new RuntimeException(); }
  ...
  static public  org.apache.spark.deploy.worker.ExecutorRunner createExecutorRunner (int execId)  { throw new RuntimeException(); }
