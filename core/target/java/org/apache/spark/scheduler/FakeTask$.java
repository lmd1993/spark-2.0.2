...
public  class FakeTask$ implements scala.Serializable {
  ...
  public  org.apache.spark.scheduler.TaskSet createTaskSet (int numTasks, int stageAttemptId, scala.collection.Seq<scala.collection.Seq<org.apache.spark.scheduler.TaskLocation>> prefLocs)  { throw new RuntimeException(); }
}
