 ...
 */
  ...
  private  java.util.concurrent.atomic.AtomicInteger nextStageId ()  { throw new RuntimeException(); }
    ...
    scala.collection.mutable.HashMap<java.lang.Object, org.apache.spark.scheduler.ShuffleMapStage> shuffleToMapStage ()  { throw new RuntimeException(); }
   ...
   * @return (undocumented)
   */
  private  org.apache.spark.scheduler.ShuffleMapStage getShuffleMapStage (org.apache.spark.ShuffleDependency<?, ?, ?> shuffleDep, int firstJobId)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  private  scala.Tuple2<scala.collection.immutable.List<org.apache.spark.scheduler.Stage>, java.lang.Object> getParentStagesAndId (org.apache.spark.rdd.RDD<?> rdd, int firstJobId)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  private  org.apache.spark.scheduler.ShuffleMapStage newShuffleMapStage (org.apache.spark.rdd.RDD<?> rdd, int numTasks, org.apache.spark.ShuffleDependency<?, ?, ?> shuffleDep, int firstJobId, org.apache.spark.util.CallSite callSite)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  private  org.apache.spark.scheduler.ResultStage newResultStage (org.apache.spark.rdd.RDD<?> rdd, scala.Function2<org.apache.spark.TaskContext, scala.collection.Iterator<?>, ?> func, int[] partitions, int jobId, org.apache.spark.util.CallSite callSite)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  private  org.apache.spark.scheduler.ShuffleMapStage newOrUsedShuffleStage (org.apache.spark.ShuffleDependency<?, ?, ?> shuffleDep, int firstJobId)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  private  scala.collection.immutable.List<org.apache.spark.scheduler.Stage> getParentStages (org.apache.spark.rdd.RDD<?> rdd, int firstJobId)  { throw new RuntimeException(); }
