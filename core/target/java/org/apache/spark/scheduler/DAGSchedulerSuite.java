...
public  class DAGSchedulerSuite extends org.apache.spark.SparkFunSuite implements org.apache.spark.LocalSparkContext, org.scalatest.concurrent.Timeouts {
  ...
  public  org.apache.spark.scheduler.SparkListener sparkListener ()  { throw new RuntimeException(); }
  ...
  private  void init (org.apache.spark.SparkConf testConf)  { throw new RuntimeException(); }
  ...
  private  int submit (org.apache.spark.rdd.RDD<?> rdd, int[] partitions, scala.Function2<org.apache.spark.TaskContext, scala.collection.Iterator<?>, ?> func, org.apache.spark.scheduler.JobListener listener, java.util.Properties properties)  { throw new RuntimeException(); }
  ...
  private  scala.collection.Seq<scala.Tuple4<java.lang.String, org.apache.spark.scheduler.ExecutorLossReason, java.lang.Object, java.lang.Object>> shuffleFileLossTests ()  { throw new RuntimeException(); }
  ...
  private  org.apache.spark.scheduler.TaskInfo createFakeTaskInfoWithId (long taskId)  { throw new RuntimeException(); }
  private  org.apache.spark.scheduler.CompletionEvent makeCompletionEvent (org.apache.spark.scheduler.Task<?> task, org.apache.spark.TaskEndReason reason, Object result, scala.collection.Seq<org.apache.spark.util.AccumulatorV2<?, ?>> extraAccumUpdates, org.apache.spark.scheduler.TaskInfo taskInfo)  { throw new RuntimeException(); }
}
