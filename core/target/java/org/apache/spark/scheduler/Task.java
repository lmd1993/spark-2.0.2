 ...
 */
 abstract class Task<T extends java.lang.Object> implements scala.Serializable {
  ...
  // not preceding
  public   Task (int stageId, int stageAttemptId, int partitionId, org.apache.spark.executor.TaskMetrics metrics, java.util.Properties localProperties)  { throw new RuntimeException(); }
  /**
