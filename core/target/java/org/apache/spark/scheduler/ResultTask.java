 ...
 */
  ...
  // not preceding
  public   ResultTask (int stageId, int stageAttemptId, org.apache.spark.broadcast.Broadcast<byte[]> taskBinary, org.apache.spark.Partition partition, scala.collection.Seq<org.apache.spark.scheduler.TaskLocation> locs, int outputId, java.util.Properties localProperties, org.apache.spark.executor.TaskMetrics metrics)  { throw new RuntimeException(); }
