...
public  class ThreadUtils {
  ...
  /**
   * Preferred alternative to {@link Await.result()}. This method wraps and re-throws any exceptions
   * thrown by the underlying {@link Await} call, ensuring that this thread's stack trace appears in
   * logs.
  ...
  /**
   * Calls {@link Awaitable.result} directly to avoid using <code>ForkJoinPool</code>'s <code>BlockingContext</code>, wraps
   ...
   * @return (undocumented)
   */
  static public <T extends java.lang.Object> T awaitResultInForkJoinSafely (scala.concurrent.Awaitable<T> awaitable, scala.concurrent.duration.Duration atMost) throws org.apache.spark.SparkException { throw new RuntimeException(); }
}
