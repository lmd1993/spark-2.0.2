...
public  class JsonProtocolSuite$ implements org.scalatest.Assertions, scala.Serializable {
  /**
   * Static reference to the singleton instance of this Scala object.
   */
  public static final JsonProtocolSuite$ MODULE$ = null;
  public   JsonProtocolSuite$ ()  { throw new RuntimeException(); }
  private  long jobSubmissionTime ()  { throw new RuntimeException(); }
  private  long jobCompletionTime ()  { throw new RuntimeException(); }
  private  long executorAddedTime ()  { throw new RuntimeException(); }
  private  long executorRemovedTime ()  { throw new RuntimeException(); }
  ...
  private  void testAccumValue (scala.Option<java.lang.String> name, Object value, org.json4s.JsonAST.JValue expectedJson)  { throw new RuntimeException(); }
  /** -------------------------------- *
   | Util methods for comparing events |
   * @param event1 (undocumented)
   * @param event2 (undocumented)
   * --------------------------------- */
    void assertEquals (org.apache.spark.scheduler.SparkListenerEvent event1, org.apache.spark.scheduler.SparkListenerEvent event2)  { throw new RuntimeException(); }
  ...
  private  void assertJsonStringEquals (java.lang.String expected, java.lang.String actual, java.lang.String metadata)  { throw new RuntimeException(); }
  ...
  private  org.apache.spark.scheduler.AccumulableInfo makeAccumulableInfo (int id, boolean internal, boolean countFailedValues, scala.Option<java.lang.String> metadata)  { throw new RuntimeException(); }
  /**
