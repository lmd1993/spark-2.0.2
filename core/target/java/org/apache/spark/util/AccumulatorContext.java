...
public  class AccumulatorContext {
   ...
   * values across multiple tasks. This is what {@link org.apache.spark.scheduler.DAGScheduler} does.
   ...
   * @return (undocumented)
   */
  static   scala.Option<org.apache.spark.util.AccumulatorV2<?, ?>> lookForAccumulatorByName (java.lang.String name)  { throw new RuntimeException(); }
