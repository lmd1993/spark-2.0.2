...
public  class DirectKafkaStreamSuite extends org.apache.spark.SparkFunSuite implements org.scalatest.BeforeAndAfter, org.scalatest.BeforeAndAfterAll, org.scalatest.concurrent.Eventually, org.apache.spark.internal.Logging {
  ...
  private  org.apache.spark.streaming.kafka.DirectKafkaInputDStream<java.lang.String, java.lang.String, kafka.serializer.StringDecoder, kafka.serializer.StringDecoder, scala.Tuple2<java.lang.String, java.lang.String>> getDirectKafkaStream (java.lang.String topic, scala.Option<org.apache.spark.streaming.scheduler.RateController> mockRateController)  { throw new RuntimeException(); }
}
