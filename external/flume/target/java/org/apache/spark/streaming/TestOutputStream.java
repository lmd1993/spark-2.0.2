...
public  class TestOutputStream<T extends java.lang.Object> extends org.apache.spark.streaming.dstream.ForEachDStream<T> {
  ...
  static public  scala.Option<org.apache.spark.rdd.RDD<scala.runtime.BoxedUnit>> compute (org.apache.spark.streaming.Time validTime)  { throw new RuntimeException(); }
  static public  scala.Option<org.apache.spark.streaming.scheduler.Job> generateJob (org.apache.spark.streaming.Time time)  { throw new RuntimeException(); }
  public  java.util.concurrent.ConcurrentLinkedQueue<scala.collection.Seq<T>> output ()  { throw new RuntimeException(); }
  // not preceding
  public   TestOutputStream (org.apache.spark.streaming.dstream.DStream<T> parent, java.util.concurrent.ConcurrentLinkedQueue<scala.collection.Seq<T>> output, scala.reflect.ClassTag<T> evidence$1)  { throw new RuntimeException(); }
