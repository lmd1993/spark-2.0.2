...
public  class BytecodeUtilsSuite extends org.apache.spark.SparkFunSuite {
  static public  class TestClass {
    public  int foo ()  { throw new RuntimeException(); }
    public  long bar ()  { throw new RuntimeException(); }
    // not preceding
    public   TestClass (int foo, long bar)  { throw new RuntimeException(); }
    public  boolean baz ()  { throw new RuntimeException(); }
  }
  ...
  public   BytecodeUtilsSuite ()  { throw new RuntimeException(); }
  private  scala.Function1<org.apache.spark.graphx.util.BytecodeUtilsSuite.TestClass, scala.runtime.BoxedUnit> c ()  { throw new RuntimeException(); }
}
