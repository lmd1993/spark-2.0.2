 ...
 * <p>
 * The first implementation uses the standalone {@link Graph} interface and runs PageRank
 ...
 * </code></pre>
 * <p>
 * The second implementation uses the {@link Pregel} interface and runs PageRank until
 * convergence:
 * <p>
 * <pre><code>
 * var PR = Array.fill(n)( 1.0 )
